...
@Component({
  selector: "app-ajouter-produit-mobile",
  templateUrl: "./ajouter-produit-mobile.component.html",
  styleUrls: ["./ajouter-produit-mobile.component.css"],
})
export class AjouterProduitMobileComponent implements OnInit {
  ...
  initForm() {
    this.produitService.dataForm = this.formBuilder.group({
      ...
      prixProduit: new FormControl(null,[
        Validators.required,
      ]),
      ...
      carburant: "",
      description: "",
      categorie_id: new FormControl(null,[
        Validators.required,
        ,
        Validators.min(1)
      ]),
      annee: 0,
      delegation_id: new FormControl(null,[
        Validators.required,
        Validators.min(1)
      ]),
      enabled: false,
  ...
  get nomProduit(){return this.produitService.dataForm.get('nomProduit')}
  get prixProduit(){return this.produitService.dataForm.get('prixProduit')}
  get categorie_id(){return this.produitService.dataForm.get('categorie_id')}
  get delegation_id(){return this.produitService.dataForm.get('delegation_id')}
