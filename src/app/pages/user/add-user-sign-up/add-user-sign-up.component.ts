...
@Component({
  selector: 'app-add-user-sign-up',
  templateUrl: './add-user-sign-up.component.html',
  styleUrls: ['./add-user-sign-up.component.css']
})
export class AddUserSignUpComponent implements OnInit {
  dropdownSettings;
  role:Role;
  roles:Role[];
  userFile ;
