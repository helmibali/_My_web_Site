...
export class ProduitsSearchComponent implements OnInit {
  ...
  selectedMarque: any = {
    id: this.activatedRoute.snapshot.params.marque,
    marqueLibelle: "",
  };

  selectedGouvernorat: any = {
    id: this.activatedRoute.snapshot.params.gouvernorat,
    libelle: "",
  };
  selectedCategorie: any = {
    id: this.activatedRoute.snapshot.params.categorie,
    nomCategorie: "",
  };
  selectedModele: any = {
    id: this.activatedRoute.snapshot.params.modele,
    libelleModele: "",
  };
  selectedDelegation: any = {
    id: this.activatedRoute.snapshot.params.delegation,
    libelle: "",
  };
  selectedFamille: any = {
    id: this.activatedRoute.snapshot.params.famille,
    libelle: "",
  };
  constructor(
  ...
  ngOnInit(): void {
    this.catService
      .listeCategorieByFamille(this.activatedRoute.snapshot.params.famille)
      .subscribe((data) => {
        this.categoriesByFamille = data;
      });
    this.delegationService
      .ListDelegationByGouvernourat_id(
  ...
  produitList() {
    this.produitService
      .listeFilter(
        ...
        this.activatedRoute.snapshot.params.gouvernorat,
        this.activatedRoute.snapshot.params.delegation
      )
      .subscribe((p) => {
  ...
  onSelect(e) {
    ...
    this.modeleService.getAllModelesByMarque_id(a).subscribe((data) => {
      this.modelesByMarque = data;
    });
  ...
  reInitFilter() {
    ...
    // this.produitList();
    this.router.navigate(["nos-produits-filtree/0/0/0/0/0/0"]).then(() => {
  ...
  essence() {
    if (!this.ess) {
      this.produitsSearch = this.produitsSearch.filter(
        (p) => p.carburant === "Essence"
      );
